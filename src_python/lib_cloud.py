...
# Input folder name and image index, output color and depth image
def read_color_depth_images(folder, index, img_format="open3d", index_len=5, image_folder="image", image_name="image", depth_doler="depth", depth_name="depth"):
    '''
    test case{
        images_folder = "/home/feiyu/baxterws/src/winter_prj/auto_collect/data/mydata"
        cam_param_file="/home/feiyu/baxterws/src/winter_prj/auto_collect/config/cam_params.json"
    ...
    str_idx = ("{:0"+str(index_len)+"d}").format(index)
    suffix = str_idx+".png"

    if img_format=="cv" or img_format=="cv2":
...
def rgbd2cloud(color, depth, pinhole_camera_intrinsic, img_format="open3d"):
    '''
    test case{
        images_folder = "/home/feiyu/baxterws/src/winter_prj/auto_collect/data/mydata"
        cam_param_file="/home/feiyu/baxterws/src/winter_prj/auto_collect/config/cam_params.json"
